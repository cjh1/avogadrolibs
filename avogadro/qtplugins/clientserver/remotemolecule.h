...
#ifndef AVOGADRO_QTPLUGINS_REMOTEMOLECULE_H
#define AVOGADRO_QTPLUGINS_REMOTEMOLECULE_H
 ...
 * @brief
 */
class RemoteMolecule : public Avogadro::QtGui::ExtensionPlugin
{
  Q_OBJECT
public:
  explicit RemoteMolecule(QObject *parent_ = 0);
  ~RemoteMolecule();
...
#endif // AVOGADRO_QTPLUGINS_REMOTEMOLECULE_H
